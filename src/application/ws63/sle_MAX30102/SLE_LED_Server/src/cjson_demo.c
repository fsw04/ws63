...
char *make_json(char *service_id, char *xin, char *xue)
{
    // 创建 JSON 对象
    ...
    // cJSON_AddStringToObject(properties, "xin", xin);
    // cJSON_AddStringToObject(properties, "xue", xue);

    cJSON_AddStringToObject(properties, "1xin", xin);
    cJSON_AddStringToObject(properties, "1xue", xue);

    // cJSON_AddStringToObject(properties, "2xin", xin);
    // cJSON_AddStringToObject(properties, "2xue", xue);
